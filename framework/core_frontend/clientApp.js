...
including nav builder, which uses routesConfig and needs only calling the func in frontend - define precisely
*/
...
function buildFooter(navData) {
    ...
    issDataDisplay.textContent = "External API response example";
